...
public class OtpServiceImpl implements OtpService {
    ...
    public void sendRegisterOtp(String email) {
        send(email, "REGISTER", "Mã xác thực đăng ký tài khoản");
    }
    ...
    public void sendResetPasswordOtp(String email) {
        send(email, "RESET_PASSWORD", "Mã xác thực đặt lại mật khẩu");
    }
    ...
    private boolean verify(String email, String type, String otp) {
        OtpToken token = repository.findTopByEmailAndTypeAndUsedFalseOrderByCreatedAtDesc(email, type)
                .orElse(null);
